...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Platform blog post with draft/published state';
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A course made up of lessons and optional quizzes';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiEnrollmentEnrollment extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Links a student to a course they enrolled in';
...
export interface ApiLessonProgressLessonProgress
  ...
  info: {
    description: 'Tracks whether a specific student completed a specific lesson';
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A single lesson belonging to a course';
    displayName: 'Lesson';
    pluralName: 'lessons';
    singularName: 'lesson';
  };
...
export interface ApiQuizResultQuizResult extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "A student's graded attempt at a quiz";
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    lessonProgress: Schema.Attribute.Relation<
      'oneToMany',
      'api::lesson-progress.lesson-progress'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    ownedCourses: Schema.Attribute.Relation<'oneToMany', 'api::course.course'>;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
